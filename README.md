...
## User Scenario
(1) Users run the downloaded app when they arrive at Haeundae Station. When a user looks at the phone screen through the app, a screen with album covers of k-pop singers on the street appears. Those icons are placed on the way from Haeundae Station to the festival venue, and users can follow them.   
